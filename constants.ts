...
export const BRAND_COMMISSION_SLABS: Record<string, Record<string, { lower: number; upper: number; rate: number }[]>> = {
  default: {
    ALL: [
      ...
      { lower: 500, upper: 1000, rate: 14.16 },
      { lower: 1000, upper: 2000000, rate: 18.88 },
      { lower: 2000000, upper: Infinity, rate: 23.6 }
    ]
  },
  [Brand.CB_COLEBROOK]: {
    ALL: [
    ...
    [ArticleType.TROUSERS]: [
      ...
      { lower: 600, upper: 800, rate: 7.08 },
      { lower: 800, upper: Infinity, rate: 17.70 }
    ],
    [ArticleType.SHIRTS]: [
      { lower: 0, upper: 600, rate: 0.0 },
      { lower: 600, upper: 800, rate: 2.36 },
      { lower: 800, upper: Infinity, rate: 17.70 }
    ]
  },
  [Brand.INDOPRIMO]: {
    ALL: [
      { lower: 0, upper: 300, rate: 0.0 },
      { lower: 300, upper: 500, rate: 0.59 },
      { lower: 500, upper: 1000, rate: 14.16 },
      { lower: 1000, upper: 2000, rate: 18.88 },
      { lower: 2000, upper: Infinity, rate: 23.6 }
    ],
    [ArticleType.DRESSES]: [
      { lower: 0, upper: 800, rate: 4.72 },
      { lower: 800, upper: 1000, rate: 21.24 },
      { lower: 1000, upper: 2000, rate: 18.88 },
      { lower: 2000, upper: Infinity, rate: 20.06 }
    ],
    [ArticleType.SHIRTS]: [
      { lower: 0, upper: 600, rate: 0.0 },
      { lower: 600, upper: 800, rate: 2.36 },
  ...
  [Brand.DEELMO]: {
    ...
    [ArticleType.KURTAS]: [
      { lower: 0, upper: 600, rate: 0.0 },
      { lower: 600, upper: 750, rate: 2.36 },
      { lower: 750, upper: Infinity, rate: 17.70 }
    ],
    [ArticleType.SHIRTS]: [
      { lower: 0, upper: 600, rate: 0.0 },
      { lower: 600, upper: 800, rate: 2.36 },
