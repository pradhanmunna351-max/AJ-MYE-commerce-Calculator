...
const findManualRule = (rules: ManualRateRule[], aisp: number, articleType: ArticleType, level: Level): ManualRateRule | undefined => {
...
export const calculateBreakdown = (
  ...
  if (rule) {
    ...
    commissionRate = getCommissionRate(tempCP, articleType, brand);
    fixedFee = getFixedFee(aisp, articleType, brand);
  }
